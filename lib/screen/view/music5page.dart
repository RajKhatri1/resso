...
class music5 extends StatefulWidget {
  const music5({Key? key}) : super(key: key);

  @override
  State<music5> createState() => _music5State();
}

class _music5State extends State<music5> {
  Homeprovider? trueprovider;
  Homeprovider? falseprovider;
  @override
  void initState() {
    super.initState();
    Provider.of<Homeprovider>(context, listen: false).leaudio();
  }
  @override
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                color: Colors.white,
                child: Image.asset("assets/images/lehnga.jpg", fit: BoxFit.cover),
              ),
              SizedBox(
                height: 20,
              ),
